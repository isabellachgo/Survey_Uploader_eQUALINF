CREATE DATABASE IF NOT EXISTS pac_db_2024_2025;
USE pac_db_2024_2025;
...
VALUES ('PROC-001-IND-001[2024-25]', 'Año académico', 'Año escolar correspondiente', '-', 'Anual', 'Texto plano', '-', 1, '2023-01-01', '', true);

-- Indicador 2: Nº asignaturas matriculadas
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-001-IND-002[2024-25]', 'Nº asignaturas matriculadas', 'Número de asignaturas en las que se matricula el estudiante', 'Conteo', 'Anual', 'Numérico', 'N/A', 1, '2023-01-01', '', true);

-- Indicador 3: Nº asignaturas aprobadas
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-001-IND-003[2024-25]', 'Nº asignaturas aprobadas', 'Número de asignaturas aprobadas por el estudiante', 'Conteo', 'Anual', 'Numérico', 'N/A', 1, '2023-01-01', '', true);

-- Indicador 4: Nº de créditos ECTS matriculados
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-001-IND-004[2024-25]', 'Nº de créditos ECTS matriculados', 'Número de créditos ECTS en los que se matricula el estudiante', 'Suma', 'Anual', 'Numérico', 'N/A', 1, '2023-01-01', '', true);

-- Indicador 5: Nº de créditos ECTS aprobados
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-001-IND-005[2024-25]', 'Nº de créditos ECTS aprobados', 'Número de créditos ECTS aprobados por el estudiante', 'Suma', 'Anual', 'Numérico', 'N/A', 1, '2023-01-01', '', true);

-- Indicador 6: Nº de créditos ECTS superados
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-001-IND-006[2024-25]', 'Nº de créditos ECTS superados', 'Número de créditos ECTS superados por el estudiante', 'Suma', 'Anual', 'Numérico', 'N/A', 1, '2023-01-01', '', true);

-- Indicador 7: Nº de créditos ECTS presentados
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-001-IND-007[2024-25]', 'Nº de créditos ECTS presentados', 'Número de créditos ECTS presentados en evaluaciones', 'Suma', 'Anual', 'Numérico', 'N/A', 1, '2023-01-01', '', true);

-- Indicador 8: Tasa de rendimiento
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-001-IND-008[2024-25]', 'Tasa de rendimiento', 'Porcentaje de rendimiento académico de los estudiantes', 'Porcentaje', 'Anual', 'Porcentaje', 'N/A', 1, '2023-01-01', '', true);

-- Indicador 9: Tasa de éxito
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-001-IND-009[2024-25]', 'Tasa de éxito', 'Porcentaje de éxito en la aprobación de asignaturas', 'Porcentaje', 'Anual', 'Porcentaje', 'N/A', 1, '2023-01-01', '', true);

-- Indicador 10: Tasa de absentismo
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-001-IND-010[2024-25]', 'Tasa de absentismo', 'Porcentaje de ausencias en clase', 'Porcentaje', 'Anual', 'Porcentaje', 'N/A', 1, '2023-01-01', '', true);
...
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-002-IND-011[2024-25]', 'Nº de empleados', 'Número total de empleados en la organización', 'Conteo', 'Mensual', 'Numérico', 'N/A', 2, '2023-02-01', '', true);

-- Indicador 12: Tasa de rotación
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-002-IND-012[2024-25]', 'Tasa de rotación', 'Porcentaje de rotación de empleados en el periodo', 'Porcentaje', 'Mensual', 'Porcentaje', 'N/A', 2, '2023-02-01', '', true);

-- Indicador 13: Índice de satisfacción
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-002-IND-013[2024-25]', 'Índice de satisfacción', 'Nivel de satisfacción de los empleados', 'Encuesta', 'Anual', 'Numérico', 'N/A', 2, '2023-02-01', '', true);

-- Indicador 14: Nº de horas de capacitación
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-002-IND-014[2024-25]', 'Nº de horas de capacitación', 'Número de horas dedicadas a capacitación', 'Suma', 'Mensual', 'Numérico', 'N/A', 2, '2023-02-01', '', true);

-- Indicador 15: Nº de ausencias
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-002-IND-015[2024-25]', 'Nº de ausencias', 'Número de ausencias registradas', 'Conteo', 'Mensual', 'Numérico', 'N/A', 2, '2023-02-01', '', true);

-- Indicador 16: coste formacion
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-002-IND-016[2024-25]', 'CosteFormacion', 'coste formacion de empleados', 'Encuesta', 'Anual', 'Numérico', 'N/A', 2, '2023-02-01', '', true);

-- Indicador 17: tasa de absentismo
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-002-IND-017[2024-25]', 'T. absentismo', 'Número de abstentismo', 'Suma', 'Mensual', 'Numérico', 'N/A', 2, '2023-02-01', '', true);

-- Indicador 18: desempeño promedio
INSERT INTO indicator_instance (coding, indicator_name, description, calc_method, period, type, standard, indicator_group_id, modified_date, field, valid)
VALUES ('PROC-002-IND-018[2024-25]', 'Desempeño promedio', 'satisfaccion general', 'Conteo', 'Mensual', 'Numérico', 'N/A', 2, '2023-02-01', '', true);
